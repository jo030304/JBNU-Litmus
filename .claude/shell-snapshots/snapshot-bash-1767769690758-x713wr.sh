...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/home/ubuntu/.claude/downloads/claude-2.0.67-linux-x64 --ripgrep'
fi
export PATH=/home/ubuntu/dmojsite/bin\:/home/ubuntu/.vscode-server/data/User/globalStorage/github.copilot-chat/copilotCli\:/home/ubuntu/.vscode-server/cli/servers/Stable-994fd12f8d3a5aa16f17d42c041e5809167e845a/server/bin/remote-cli\:/home/ubuntu/.local/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/games\:/usr/local/games\:/snap/bin\:/home/ubuntu/.vscode-server/extensions/ms-python.debugpy-2025.18.0-linux-x64/bundled/scripts/noConfigScripts
