...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/home/ubuntu/.local/share/claude/versions/2.0.76 --ripgrep'
fi
export PATH=/home/ubuntu/dmojsite/bin\:/home/ubuntu/.vscode-server/data/User/globalStorage/github.copilot-chat/copilotCli\:/home/ubuntu/.vscode-server/cli/servers/Stable-585eba7c0c34fd6b30faac7c62a42050bfbc0086/server/bin/remote-cli\:/home/ubuntu/.local/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/games\:/usr/local/games\:/snap/bin\:/home/ubuntu/.vscode-server/extensions/ms-python.debugpy-2025.18.0-linux-x64/bundled/scripts/noConfigScripts
